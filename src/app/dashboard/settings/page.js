  ...
  useEffect(() => {     
    async function fetchSettings() {       
      ...
      const { data, error } = await supabase         
        .from('clients')         
        .select('id, primary_color, secondary_color, logo_url, instagram_link, facebook_link, website_link, yelp_link, appointment_duration')         
          ...
          <div className="flex flex-col sm:flex-row sm:items-center gap-4 sm:gap-6 flex-1">             
            ...
            <div>               
              ...
              <p className="text-zinc-400 text-sm md:text-lg max-w-xl">                 
                Update your branding, logos, scheduling rules, and public social links.               
              </p>             
            </div>           
          </div>                      
